...
const NavLinks = () => {
    return (
        <>
            ...
            <Link className="text-white btn-color hover:bg-blue-800 inline-flex items-center justify-center w-auto px-6 py-3 shadow-xl rounded-xl" smooth to="/get-demo">
                Demo our products
            </Link>
        </>
    )
